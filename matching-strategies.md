...
Every bullet in the final resume should be there for a reason. This file describes how to score candidates from the experience library against each template slot, and how to make honest reframing decisions when the language doesn't quite line up with what the role is asking for.
