# Experience Discovery — Conversation Guide

## Overview

People almost always have more relevant experience than their resume shows. This guide drives a branching conversation to surface it. The key is that each answer shapes the next question — this is not a checklist to read top to bottom. Follow the thread.
